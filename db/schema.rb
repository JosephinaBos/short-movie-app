...
ActiveRecord::Schema.define(version: 20161111120036) do
  ...
  create_table "wishlist_movies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["movie_id"], name: "index_wishlist_movies_on_movie_id", using: :btree
  ...
  add_foreign_key "wishlist_movies", "users"
end
